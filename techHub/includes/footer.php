...
<style>
    ...
    .footer-bg {
        background-color: #f5f1ed; /* A very light, warm off-white */
    ...
    .footer-bottom-bg {
        background-color: #e0d9d3; /* A slightly darker nude for the bottom bar */
        color: #4a3f35;
    }
</style>
    ...
    <div class="container text-center text-md-start">
        <div class="row">
            ...
            <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mt-3">
                <h6 class="text-uppercase mb-4 fw-bold">Store Admin</h6>
                <p>
                    Your central hub for managing products, categories, and brands. Streamline your e-commerce operations with an intuitive and elegant interface.
                </p>
            </div>
            ...
            <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
                ...
                <p><a href="brands.php">Brands</a></p>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                &copy; <?php echo date('Y'); ?> Store Management System. All Rights Reserved.
            </div>
        </div>
    </div>
</div>
